...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'members'], function () {
        ...
        Route::get('/destroy/{id}', [MemberController::class, 'destroy'])->name('members.destroy');
    ...
    Route::group(['prefix' => 'outlets'], function () {
        ...
        Route::get('/destroy/{id}', [OutletController::class, 'destroy'])->name('outlets.destroy');
    ...
    Route::group(['prefix' => 'statuses'], function () {
        ...
        Route::get('/destroy/{id}', [StatusController::class, 'destroy'])->name('statuses.destroy');
    ...
    Route::group(['prefix' => 'packages'], function () {
        ...
        Route::get('/destroy/{id}', [PackageController::class, 'destroy'])->name('packages.destroy');
